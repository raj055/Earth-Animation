              ...
              PositionedTransition(
                rect: RelativeRectTween(
                  begin: RelativeRect.fromSize(
                    const Rect.fromLTWH(100, 100, bigLogo, bigLogo),
                    biggest,
                  ),
                  end: RelativeRect.fromSize(
                      Rect.fromLTWH(
                        150,
                        biggest.height - bigLogo - 180,
                        bigLogo,
                        bigLogo,
                      ),
                      biggest),
                ...
                child: const Padding(padding: EdgeInsets.all(8), child: MyAnimatedWidget()),
              ),
              const Positioned(
                bottom: -220,
                right: 0,
